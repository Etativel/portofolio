import "./FoodlensLinks.scss";
import {useContext, useEffect, useState} from "react";
import Client from "../../svg/Client";
import StyleContext from "../../../contexts/StyleContext";

function FoodlensLinks() {
  ...
  return (
    mounted && (
      <div className={isDark ? "link-wrapper dark" : "link-wrapper"}>
        <a
          href="https://github.com/Etativel/FoodLens"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://foodlens.up.railway.app/home"
          target="_blank"
          rel="noreferrer"
        >
