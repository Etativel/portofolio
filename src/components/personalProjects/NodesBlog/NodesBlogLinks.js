import "./NodesBlogLinks.scss";
import {useContext, useEffect, useState} from "react";
import Client from "../../svg/Client";
import StyleContext from "../../../contexts/StyleContext";

function NodesBlogLinks() {
  ...
  return (
    mounted && (
      <div className={isDark ? "link-wrapper dark" : "link-wrapper"}>
        ...
        <a
          href="https://nodes-blog.up.railway.app/"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://nodes-admin.up.railway.app/"
          target="_blank"
          rel="noreferrer"
        >
          <button className="live-button">
